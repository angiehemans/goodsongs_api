...
Rails.application.configure do
  ...
  # Allow all hosts in development (needed for Docker deployment)
  config.hosts.clear
  ...
  # Use async adapter for background jobs (same as production)
  # This ensures jobs execute automatically in a thread pool
