class ProfileThemeSerializer
  ...
  def self.full(theme, include_draft: false, user: nil)
    ...
    data = {
      ...
      header_font_name: ProfileTheme.font_display_name(theme.header_font),
      header_font_weight: theme.header_font_weight,
      body_font: theme.body_font,
      body_font_name: ProfileTheme.font_display_name(theme.body_font),
      body_font_weight: theme.body_font_weight,
      custom_font_urls: theme.custom_font_urls,
    ...
    data[:config] = {
      ...
      font_weights: ProfileTheme::FONT_WEIGHTS,
